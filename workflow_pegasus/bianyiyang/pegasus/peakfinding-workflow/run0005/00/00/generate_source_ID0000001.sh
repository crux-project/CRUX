...
if [ ! -x generate_source ]; then
    /bin/chmod +x generate_source
fi
...
pegasus-kickstart  -n generate_source -N ID0000001 -R condorpool  -L peakfinding-workflow -T 2022-06-08T22:51:12-04:00 ./generate_source -a generate_sourcecard -T 3 -i -o
job_ec=$?
