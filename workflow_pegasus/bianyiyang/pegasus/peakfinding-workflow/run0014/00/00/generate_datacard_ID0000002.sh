...
if [ ! -x generate_datacard ]; then
    /bin/chmod +x generate_datacard
fi
...
pegasus-kickstart  -n generate_datacard -N ID0000002 -R condorpool  -L peakfinding-workflow -T 2022-06-09T14:03:17-04:00 ./generate_datacard -a generate_datacard -T 3 -i  -o
job_ec=$?
