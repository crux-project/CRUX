...
pegasus-kickstart  -n generate_source -N ID0000001 -R condorpool  -L peakfinding-workflow -T 2022-06-09T13:31:38-04:00 ./generate_source -a generate_sourcecard -T 3 -i -o
job_ec=$?
