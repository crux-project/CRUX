...
if [ ! -x generate_source_py ]; then
    /bin/chmod +x generate_source_py
fi
...
pegasus-kickstart  -n generate_source.py -N ID0000001 -R condorpool  -L peakfinding-workflow -T 2022-06-08T22:43:32-04:00 ./generate_source_py -a generate_sourcecard -T 3 -i -o
job_ec=$?
